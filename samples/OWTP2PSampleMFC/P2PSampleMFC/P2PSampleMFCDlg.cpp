...
void CP2PSampleMFCDlg::OnBnClickedConnectButton()
{
	...
	if (peerServerDlg.DoModal() == IDOK) {
		...
		owt::base::IceServer ice_server;
		ice_server.urls.push_back("turn:18.138.196.140:3478");
		ice_server.username = "turn_user";
		ice_server.password = "Y2Ytb3BlbnZpZHUtYmxh";
		configuration_.ice_servers.push_back(ice_server);
		ice_server.urls.clear();
		ice_server.urls.push_back("stun:3.8.171.200:3478");
		configuration_.ice_servers.push_back(ice_server);
		ice_server.urls.clear();
		ice_server.urls.push_back("stun:18.138.196.140:3478");
		configuration_.ice_servers.push_back(ice_server);
		ice_server.urls.clear();
		ice_server.urls.push_back("stun:3.84.195.253:3478");
		configuration_.ice_servers.push_back(ice_server);
		ice_server.urls.clear();
		ice_server.urls.push_back("turn:3.91.80.102:3478");
		configuration_.ice_servers.push_back(ice_server);
		ice_server.urls.clear();
		ice_server.urls.push_back("turn:3.84.195.253:3478");
		configuration_.ice_servers.push_back(ice_server);
		ice_server.urls.clear();
		ice_server.urls.push_back("stun:3.91.80.102:3478");
		configuration_.ice_servers.push_back(ice_server);
		ice_server.urls.clear();
		ice_server.urls.push_back("stun:13.251.124.178:3478");
		configuration_.ice_servers.push_back(ice_server);
		ice_server.urls.clear();
		ice_server.urls.push_back("turn:3.8.171.200:3478");
		configuration_.ice_servers.push_back(ice_server);
		ice_server.urls.clear();
		ice_server.urls.push_back("turn:13.251.124.178:3478");
		configuration_.ice_servers.push_back(ice_server);
		ice_server.urls.clear();
		ice_server.username.clear();
		ice_server.password.clear();
		ice_server.urls.push_back("stun:stun.l.google.com:19302");
		configuration_.ice_servers.push_back(ice_server);
		ice_server.urls.clear();
		ice_server.urls.push_back("stun:stun1.l.google.com:19302");
		configuration_.ice_servers.push_back(ice_server);
		ice_server.urls.clear();
		ice_server.urls.push_back("stun:stun2.l.google.com:19302");
		configuration_.ice_servers.push_back(ice_server);
		ice_server.urls.clear();
		ice_server.urls.push_back("stun:stun3.l.google.com:19302");
		configuration_.ice_servers.push_back(ice_server);
		ice_server.urls.clear();
		ice_server.urls.push_back("stun:stun4.l.google.com:19302");
		configuration_.ice_servers.push_back(ice_server);
